...
class DQN:
    ...
    def train(self):
        ...
        if self.transition_count >= self.replay_size/2:
            ...
            # Only actions taken should be updated with the reward
